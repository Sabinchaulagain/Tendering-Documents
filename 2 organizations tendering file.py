...
declaration_title_style = ParagraphStyle(
    name="DeclTitle",
...
def create_poa_with_declaration_pdf(
    ...
    elements.append(Paragraph("<u>Power Of Attorney</u>", poa_title_style))
    ...
    elements.append(Spacer(1, 12))
    elements.append(Paragraph(f"Whereas, <b>{employer_name}</b>", poa_body))
    elements.append(Spacer(1, 12))
    ...
    elements.append(Paragraph(f"<b>To,<br/>{employer_name},<br/>{employer_address}</b>", poa_body))
    elements.append(Spacer(1, 8))
    elements.append(Paragraph(f"<b>For: {contract_name} and Invitation for Bids No.: {bid_number}</b>", poa_body))
    elements.append(Spacer(1, 12))

    elements.append(Paragraph("<u>Subject: Letter of Declaration</u>", declaration_title_style))
    elements.append(Spacer(1, 12))

    elements.append(Paragraph("Dear Sir,", poa_body))
    elements.append(Paragraph(
